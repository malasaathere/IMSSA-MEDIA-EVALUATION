...
import { loginOrSignupWithPin, loginWithGoogle } from "../../api/auth";
    ...
    <div className="space-y-6">
      ...
      <div>
        <button
          ...
          className="w-full inline-flex justify-center py-2 px-4 border border-slate-300 rounded-md shadow-sm bg-white text-sm font-medium text-slate-500 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-navy-500 transition-colors"
        >
